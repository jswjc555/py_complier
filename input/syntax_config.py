production = [
    ...
    {"left": "DECLARE_CLASS",
     "right": ["FIELD_TYPE", "OPTIONAL_FIELD_TYPE", "TYPEDEF", "ID", "DECLARE_INIT", "DECLARE_VARS", ";"]},
    {"left": "METHOD_CLASS",
     "right": ["FIELD_TYPE", "OPTIONAL_FIELD_TYPE", "TYPEDEF", "ID", "(", "ARGS", ")", "{", "BLOCK_STMT", "}"]},
    {"left": "METHOD_CLASS",
     "right": ["FIELD_TYPE", "OPTIONAL_FIELD_TYPE", "TYPEDEF", "main", "(", "ARGS", ")", "{", "BLOCK_STMT", "}"]},
    ...
    {"left": "FOR_STMT",
     "right": ["for", "(", "FOR_EXPRESSION", ";", "EXPRESSION", ";", "EXPRESSION", ")", "{", "BLOCK_STMT", "}"]},
